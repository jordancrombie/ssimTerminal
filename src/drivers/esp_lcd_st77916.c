 ...
 * @brief ESP-IDF LCD panel driver for ST77916
 *
 * Based on Waveshare ESP32-S3-Touch-LCD-1.85C demo code
...
// Vendor-specific initialization sequence for ESP32-S3-Touch-LCD-1.85C-BOX
static const st77916_lcd_init_cmd_t vendor_specific_init_default[] = {
    ...
    {0xF0, (uint8_t []){0x00}, 1, 0},
    {0x21, (uint8_t []){0x00}, 1, 0},      // Inversion ON
